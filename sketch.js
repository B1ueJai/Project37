...
function setup() {
  ...
  // Define gameOver, restart button
...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    // Increase score when shrub collides with the kangaroo
    ...
    // Display GameOver and restart button when gameState = End
...
function spawnObstacles() {
  ...
  //reset function to reset all objects
function reset() {
    score = 0;
    gameState = PLAY;
